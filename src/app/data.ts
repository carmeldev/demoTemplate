export const productsList = [
  { name: 'Nike', type: 'women', price: 50, rating: 4.5, imageUrl: '', size: 7, offer: 50, category: 'shoe' },
  { name: 'Nike', type: 'women', price: 50, rating: 4.5, imageUrl: '', size: 7, offer: 50, category: 'shoe' },
  { name: 'Nike', type: 'women', price: 50, rating: 4.5, imageUrl: '', size: 7, offer: 50, category: 'shoe' },
  { name: 'Nike', type: 'women', price: 50, rating: 4.5, imageUrl: '', size: 7, offer: 50, category: 'shoe' },
];
export const productDetails = [{
  img: '../../../assets/nike shoe.PNG',
...
},
{
  ...
  name: 'Shining Blown Stunner Red High Heels',
  type: 'High heels',
  price: '$ 62',
  size: 'Large',
  offer: '35%',
...
},
{
  // tslint:disable-next-line: max-line-length
  img: '../../../assets/Boot.jpg',
  name: 'MERRELL Silversun Lace Waterproof Boots',
  type: 'Boots',
  price: '$ 90',
  size: 'Medium',
  offer: '20%',
